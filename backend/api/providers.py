...
async def update_provider(
    ...
    try:
        ...
        # Update fields
        updateable_fields = [
            "name", "domain", "public_key", "certificate_fingerprint",
            "api_url", "provider_type", "status", "provider_metadata", "is_active"
        ]
...
async def get_provider_types(db: Session = Depends(get_db)) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "suggested_types": [
                "wallet", "exchange", "merchant", "payment_processor",
                "lightning_provider", "donation", "service"
            ]
        }
