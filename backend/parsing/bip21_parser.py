...
class BIP21Parser:
    ...
    def parse(self, content: str) -> Dict[str, Any]:
        ...
        Args:
            content: Bitcoin URI string (e.g., "bitcoin:1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa?amount=0.001")
        ...
        return {
            ...
            'validation': {
                ...
                'amount_valid': amount_satoshis is not None if 'amount' in params else True
            }
        }
